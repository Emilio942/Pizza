...
OUTPUT_DIR="/home/emilio/Documents/ai/pizza/augmented_pizza/augmentation_test_results"
mkdir -p "$OUTPUT_DIR"

# Run the test script
echo "Running augmentation test..."
python3 /home/emilio/Documents/ai/pizza/scripts/run_augmentation_test.py --image "$PIZZA_IMG" --output-dir "$OUTPUT_DIR"
