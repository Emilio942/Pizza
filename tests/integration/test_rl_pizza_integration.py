...
# Skip this module by default to keep the lightweight pytest suite focused on unit tests.
pytestmark = pytest.mark.skip(reason="RL integration harness requires heavy dependencies not available in CI")
...
from src.models.architectures import MicroPizzaNet, MicroPizzaNetV2
