...
This module collects verified pizza recognition data from:
1. Formal verification reports
2. Diffusion analysis evaluation data  
3. Augmented pizza datasets
4. Model evaluation results

Goal: Create high-quality positive examples for verifier training.
"""
...
# Import our pizza quality data structures
try:
    from pizza_quality_data import (
        PizzaQualityData, 
        ErrorType, 
        HardwarePlatform,
        PizzaVerifierDataset
    )
except ImportError:
    # Define minimal structures if import fails
    ...
    def save_positive_examples(self, positive_examples: List[PizzaQualityData]) -> str:
        ...
        with open(output_file, 'w') as f:
            json.dump({
                ...
                "samples": [asdict(example) for example in positive_examples]
            }, f, indent=2)
